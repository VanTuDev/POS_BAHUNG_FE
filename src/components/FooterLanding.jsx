      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-1">
            <h3 className="text-xl font-bold mb-4">POS Bahung</h3>
            <p className="text-gray-400 mb-4">
              Giải pháp quản lý bán hàng toàn diện cho doanh nghiệp vừa và nhỏ.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li className="flex items-start">
                ...
                <span className="text-gray-400">contact@posbahung.com</span>
              </li>
              <li className="flex items-start">
                <svg
                  className="w-5 h-5 text-gray-400 mr-2 mt-0.5"
        ...
        <div className="border-t border-gray-700 mt-10 pt-6">
          <p className="text-gray-400 text-sm text-center">
            &copy; {new Date().getFullYear()} POS Bahung. Tất cả các quyền được
            bảo lưu.
          </p>
        </div>
      </div>
